...
from my.loss_trans_obj import transpose_with_object_loss
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--save_dir', type=str, default=os.path.join('checkpoints', 'transpose_trans_object_omomo'),
            ...
            for batch in val_loader:
                ...
                with autocast(enabled=args.use_amp):
                    ...
                    targets = {
                        ...
                        'velocity_local': batch['velocity_local'],
                        'root_velocity_world': batch['root_velocity_world'],
